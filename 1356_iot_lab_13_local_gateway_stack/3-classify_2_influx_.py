...
INFLUXDB_TOKEN = "k_ozfQ0cMBRtB0bXzrHNgJRquMHGnkXmc74CBtAlwL9dltRaFQ59oWfcVaw9UPD6LHr-_vHZh2GlmL1sQA933A=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "iotlab"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "iotlab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.1.14"  # ESP32's MQTT broker address
